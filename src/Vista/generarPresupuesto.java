...
public class generarPresupuesto extends JInternalFrame {
	...
	private void iniciarComponentes() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (controlador.existeCliente(tipoDoc, numeroDoc)) {
					...
					JOptionPane.showMessageDialog(null,
							"NO EXISTE CLIENTE, INGRESE UN CLIENTE EXISTENTE");
				}
			}
		});
		...
		final JCheckBox aireAcondicionadoCB = new JCheckBox(
				"Aire Acondicionado");
		...
		verVehiculosBOTON.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// VER COMO HACER PARA DEVOLVER NULL CUANDO NO SE ELIJAN
				// OPCIONES DE LOS COMBOBOX
				// Ver que hace el parametro NOMBRE
				// Aca estoy usando todo con DTOS y String, entiendo que no va
				// en contra de MVC, que lo chekee leo
