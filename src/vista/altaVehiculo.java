...
public class altaVehiculo extends JInternalFrame {
	...
	public altaVehiculo() {
		...
		lblMarca.setBounds(68, 61, 46, 14);
		getContentPane().add(lblMarca);
		
		JLabel lblModelo = new JLabel("Modelo");
		lblModelo.setBounds(68, 100, 46, 14);
		...
		lblTransmision.setBounds(248, 100, 68, 14);
		getContentPane().add(lblTransmision);
		
		JComboBox comboBox_1 = new JComboBox();
		comboBox_1.setBounds(314, 97, 70, 20);
		...
		lblDominio.setBounds(68, 202, 46, 14);
		...
		lblColor.setBounds(68, 227, 46, 14);
		...
		lblSucursal.setBounds(68, 276, 46, 14);
